...
// console.log(name)
  return (
    <div className="card">
      ...
      /> */}
      {/* <h2>{id}</h2> */}
      {/* <h3>{restrautList[4].data?.name}</h3> */}
      <h2>{name}</h2>
...
const Body = () => {
  return (
    ...
    <div className="restaurant-list">
      {restrautList.map((restaurantt) => {
        return <RestrauntCard {...restaurantt.data} key={restaurantt.data.id}  />;
      })}
    </div>
    </>
...
{/* <RestrauntCard name={restrautList[3].data.name} 
area={restrautList[3].data.area}/> */}
